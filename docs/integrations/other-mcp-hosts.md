...
Same as for every host: [Get started](../getting-started/README.md#4-optional-extras-only-if-you-want-them) and [Troubleshooting](../getting-started/troubleshooting.md).

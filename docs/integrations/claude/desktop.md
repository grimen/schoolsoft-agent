...
This guide uses **Chat in the desktop app**. If you are using Claude in a browser or on your phone, open the desktop app on your computer first. [Cowork and other environments](web-cowork.md) have separate requirements.
...
- For contacts, files or other extra information, follow [optional features](../../getting-started/README.md#4-optional-extras-only-if-you-want-them).
...
[More troubleshooting](../../getting-started/troubleshooting.md) · [Choose a different assistant](../../getting-started/README.md)

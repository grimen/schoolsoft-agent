...
[Optional browser features](../../getting-started/README.md#4-optional-extras-only-if-you-want-them) · [Troubleshooting](../../getting-started/troubleshooting.md) · [Support matrix](../support-matrix.md)

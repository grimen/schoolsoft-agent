...
**Spec:** `docs/superpowers/specs/2026-09-06-two-surface-foundation-design.md`
...
**Files:**
- Create: `docs/architecture.md` (5 Mermaid diagrams per spec §7), `docs/schoolsoft-api.md`, `docs/hosts/{claude-code,claude-desktop,opencode,openclaw,hermes,pi}.md`, `docs/reference/` (generated), `CHANGELOG.md`

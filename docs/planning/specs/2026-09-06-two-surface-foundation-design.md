...
- `docs/development/architecture.md`: the component diagram above; sequence diagram of
...
- `docs/reference/schoolsoft-api.md`: endpoint catalogue with the guardian-vs-student
  findings, headers, and what 404s.
- `docs/integrations/<host>.md`: install, configure, sandbox caveats.

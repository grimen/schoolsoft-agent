...
acceptance are still required. See [hosting choices](README.md) before
...
[Docker setup step 2](connector.md#route-2-docker-on-your-own-server) to make
...
[SchoolSoft and AI-app connection](connector.md#connect-your-school-and-ai-app).
...
follow the [data-removal guidance](connector.md#everyday-use-and-recovery).

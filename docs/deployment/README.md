...
[parent guide](connector.md#before-you-start).

| Your situation                                                               | Choose                                                                   | What you pay for                                                                       | What you maintain                                                    |
| ---------------------------------------------------------------------------- | ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| You want fewer server administration steps                                   | [Render](connector.md#route-1-your-render-account)                       | Paid service and persistent disk; no separate domain required for its supplied address | Secrets, manual app updates, account security and access permissions |
...
| You use another Linux VPS provider                                           | [Portable Docker recipe](connector.md#route-2-docker-on-your-own-server) | VPS, domain and backup options                                                         | Same responsibilities as Hostinger; dashboard buttons differ         |
...
setups. Read the [full privacy explanation](connector.md#what-is-private-and-from-whom).

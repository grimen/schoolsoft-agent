...
Start with **[Claude Desktop: step-by-step setup](../integrations/claude/desktop.md)**. You install the Claude app and one SchoolSoft extension file. You do not need a terminal or a server. Check that your Claude account allows extensions before buying anything.
...
[ChatGPT desktop / Codex](../integrations/openai/codex.md) · [OpenClaw](../integrations/openclaw.md) · [Hermes](../integrations/hermes.md) · [Pi](../integrations/pi.md) · [OpenCode](../integrations/opencode.md) · [Claude Code](../integrations/claude/code.md)
...
If you choose the connector, [compare hosting options](../deployment/README.md) and follow its guide from here: the computer instructions below cover the local routes.

Not sure whether your app is supported? The [detailed support matrix](../integrations/support-matrix.md) explains desktop, web, mobile and advanced options. You can skip it if you have chosen a guide.
...
Containers, WSL and remote servers running the local agent need additional browser, network and saved-session configuration. The separate [parent-hosted connector recipe](../deployment/connector.md) uses an HTTPS callback instead of localhost. Follow the [support matrix](../integrations/support-matrix.md) before choosing one of these environments.
...
[What you can ask](../reference/tools.md) · [Privacy](../../README.md#privacy) · [Support matrix](../integrations/support-matrix.md)

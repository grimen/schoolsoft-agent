...
| Menu item (sv)                                                                  | Page                                                                                                                                                                       | With our session                      | Tier / API                                                                                                                                                |
| ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Startsida                                                                       | `right_student_startpage.jsp`                                                                                                                                              | 200                                   | JSP (embeds React)                                                                                                                                        |
| Aktuellt / Nyheter                                                              | `right_student_news.jsp`                                                                                                                                                   | 200                                   | JSP; news also via Eva `news`                                                                                                                             |
| Kalender                                                                        | `right_student_week_calendar.jsp`                                                                                                                                          | 200                                   | JSP + React `#/parent/calendar`; REST `/rest-api/parent/calendar/lessons/week/{w}`, `/calendar/settings`                                                  |
| Verksamhetslogg                                                                 | `right_student_blogpost.jsp`                                                                                                                                               | 200                                   | JSP only                                                                                                                                                  |
| Matsedel                                                                        | React `#/student/lunchmenu`                                                                                                                                                | —                                     | Eva `lunchmenu`                                                                                                                                           |
| Bokningar                                                                       | `right_student_timebooking.jsp`                                                                                                                                            | 200                                   | JSP only (booking = form post)                                                                                                                            |
| Meddelanden                                                                     | `right_student_message.jsp`                                                                                                                                                | 200, 2 POST forms                     | JSP; inbox also via Eva `messages`; **send = form post**                                                                                                  |
| Scheman / Provschema                                                            | `right_student_schedule.jsp`, `right_student_test_schedule.jsp`                                                                                                            | 200                                   | JSP; lessons also via REST calendar                                                                                                                       |
| Kontaktlistor                                                                   | `right_student_class.jsp`                                                                                                                                                  | 200                                   | JSP only                                                                                                                                                  |
| Ämne (subject rooms)                                                            | `right_student_subject.jsp`                                                                                                                                                | 200                                   | JSP only                                                                                                                                                  |
| Planeringar & uppgifter                                                         | `right_student_planning.jsp`                                                                                                                                               | 302 → React error                     | REST `/rest-api/parent/ps/planning_parts/start-page`, `/ps/assignments/start-page`                                                                        |
| Uppgifter & resultat                                                            | `right_student_test.jsp`                                                                                                                                                   | 200                                   | JSP; assignments via REST `ps/assignments`                                                                                                                |
| Forum                                                                           | `right_student_forum_list.jsp`                                                                                                                                             | 302 → React error                     | unknown                                                                                                                                                   |
| Frånvaroanmälan                                                                 | `right_student_absence.jsp`                                                                                                                                                | 200, 4 POST forms                     | JSP form post; REST `POST /rest-api/parent/absence-notice` also exists (GET → 405)                                                                        |
| Ledighetsansökan                                                                | `right_student_studentleave.jsp`                                                                                                                                           | 200, 1 POST form                      | JSP form post                                                                                                                                             |
| Mina tider (fritids)                                                            | `right_parent_preschool_schedule_new.jsp`                                                                                                                                  | 200, 1 POST form                      | JSP form post                                                                                                                                             |
| Alla filer & länkar                                                             | `right_student_library.jsp`                                                                                                                                                | 200                                   | JSP only                                                                                                                                                  |
| Elevdokument, Kriterier, Betyg, Avstämning, Oanmäld frånvaro, Översikt, Rapport | `right_student_review/ability/gradesubject/gradeprognosis.jsp`, `right_parent_absence_message.jsp`, `right_student_lesson_status.jsp`, `right_student_absence_student.jsp` | 302 → `right_student_app_blocked.jsp` | **GDPR gate**: "requires a login to be shown, log in again (SAML)". Not reachable from an app-derived session at all; would need a real web-login session |
...
- Everything this project reads today is JSON (Eva or webview REST). The
  GUI is broader: contact lists, subject rooms, activity log, bookings,
  test schedule, files exist only as JSP HTML.

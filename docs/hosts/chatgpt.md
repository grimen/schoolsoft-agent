...
| Standalone ChatGPT web/mobile with no connected computer | [Parent-hosted connector](parent-connector.md); release candidate, real client/mobile acceptance pending |

...
For a graphical starting point, use the [Claude Desktop Chat extension](claude-desktop.md). Claude Code has a [separate guide](claude-code.md). Other Claude environments have different runtime and login requirements.
...
1. First install the [desktop extension](claude-desktop.md) and verify a read in Chat.

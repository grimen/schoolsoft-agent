...
Read [hosting choices](hosting-options.md) first. This is a release candidate;
...
Follow [Docker setup steps 2–3](parent-connector.md#route-2-docker-on-your-own-server)
...
Finish [connecting SchoolSoft and your AI app](parent-connector.md#connect-your-school-and-ai-app).
...
[removal and backup guidance](parent-connector.md#everyday-use-and-recovery), then
